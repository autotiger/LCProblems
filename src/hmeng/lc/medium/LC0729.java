...
public class LC0729 {
    ...
    public boolean book(int start, int end) {
        ...
        Map.Entry<Integer, Integer> lower = map.lowerEntry(start);
    ...
    public static void main(String[] args) {
        ...
        int[][] intervals = {{47,50},{33,41},{39,45},{33,42},{25,32},{26,35},{19,25}};
        for (int[] interval : intervals)
            System.out.print(lc.book(interval[0], interval[1]) + ", ");
    }
